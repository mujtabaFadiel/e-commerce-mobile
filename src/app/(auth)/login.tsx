import {
    ...
    TouchableOpacity, View, StatusBar, StyleSheet, Alert,
    ActivityIndicator,
} from 'react-native'
...
const styles = StyleSheet.create({
    ...
    title: { color: '#fff', fontSize: 26, fontWeight: '500', lineHeight: 32 },
    card: {
    ...
    primaryBtn: {
        height: 52, backgroundColor: DARK, borderRadius: 14,
    ...
    googleBtn: {
        height: 50, borderWidth: 1, borderColor: '#ececec', borderRadius: 14,
        flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
        gap: 10, marginBottom: 28,
    },
    googleBtnText: { fontSize: 14, color: '#444' },
    footer: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 4 },
    footerText: { fontSize: 13, color: '#aaa' },
    footerLink: { fontSize: 13, fontWeight: '500', color: DARK },
})